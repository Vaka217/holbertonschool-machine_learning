...
class BayesianOptimization:
    ...
    Class constructor def __init__(self, f, X_init, Y_init, bounds, ac_samples,
    ...
    Public instance method def acquisition(self): that calculates the next best
    sample location

    Public instance method def optimize(self, iterations=100): that optimizes
