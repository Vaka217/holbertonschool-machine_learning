...
def create_masks(inputs, target):
    ...
    Returns: encoder_mask, combined_mask, decoder_mask
        ...
        (batch_size, 1, 1, seq_len_in) used in the 2nd attention block in
        the decoder."""
    ...
    look_last_dims = (target.shape[1], target.shape[1])
    look_ahead_mask = 1 - tf.linalg.band_part(tf.ones(look_last_dims), -1, 0)
