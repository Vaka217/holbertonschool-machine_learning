    ...
    def gradient_descent(self, Y, cache, alpha=0.05):
        ...
        for i in range(self.L, 0, -1):
            ...
            if self.__activation == "sig":
                ...
                dZ = np.dot(self.weights["W{}".format(i)].T, dZ) * (1 - cache[
                    "A{}".format(i - 1)] ** 2)
